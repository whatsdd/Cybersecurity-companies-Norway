...
CAPABILITIES = {
    ...
    "physical-security", "crypto-blockchain-audit", "ai-security", "application-security", "api-security",
    "mobile-security", "code-review", "secure-development", "devsecops", "security-architecture",
    "soc", "incident-response", "crisis-management", "threat-intelligence", "threat-hunting", "digital-forensics",
